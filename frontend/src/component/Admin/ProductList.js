...
import {clearErrors,getAdminProduct,deleteProduct} from '../../actions/productAction.js'
            ...
            renderCell: (params) => {
                return (
                    <Fragment>
                        ...
                        <Button onClick={()=>{deleteProductHanler(params.getValue(params.id, 'id'))}}>
                          <DeleteIcon/>
                        </Button>
                  </Fragment>
              )
